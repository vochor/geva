...
public class Tutorial7 extends AbstractRun {
	 ...
	 */
        ...
        //State has a data member Algorithm alg; Algorithm is an interface and MyFirstSearchEngine is a simple but surprisingly flexible implementation.  
    ...
    public static void main(String[] args) {
        try{
//Create the Tutorial7 object
            Tutorial7 mfs = new Tutorial7();
		...
		int its = mfs.run(); //Returns the number of iterations performed
                System.out.println("Well done running: Tutorial7 for "+its+", now look at Tutorial8");
            }
        } catch(Exception e) {
